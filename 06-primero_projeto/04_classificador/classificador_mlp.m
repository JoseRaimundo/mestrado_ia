...
xva=1.2; 			    % DESVIO MÉDIO DO CONJUNTO DE TREINAMENTO
...
epochmax=1000;		% MÁXIMO NÚMERO DE ÉPOCAS
epochexb=1;
...
ap=plot(xa1,xa2,'b.',xb1,xb2,'ko'); set(ap,'markerSize',11);
xla=xlabel('x1');
yla=ylabel('x2');
tit=title('Conjunto de Treinamento');
