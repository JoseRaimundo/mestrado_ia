        ...
        function [obj,plane] = render(obj,plane)
            ...
            for i=1:length(obj.boids)
                ...
                if obj.boids(i).tipo == 1
                    ...
                    plane.boids_figure_handles(i) =  patch(x,y,'r');
                elseif obj.boids(i).tipo == 2
                    x = [obj.boids(i).position(1)-2 obj.boids(i).position(1)+3 obj.boids(i).position(1)+3 obj.boids(i).position(1)-2];
                    y = [obj.boids(i).position(2)-2 obj.boids(i).position(2)-2 obj.boids(i).position(2)+3 obj.boids(i).position(2)+3];
                    plane.boids_figure_handles(i) =  patch(x,y,[0 0 0 0], 'k');                 
                else
                    x = [obj.boids(i).position(1)-2.5 obj.boids(i).position(1)+2.5 obj.boids(i).position(1)-2.5 obj.boids(i).position(1)-2.5];
                    y = [obj.boids(i).position(2)-1.5 obj.boids(i).position(2) obj.boids(i).position(2)+1.5 obj.boids(i).position(2)+1.5];
                    plane.boids_figure_handles(i) =  patch(x,y,'g');
                end;
